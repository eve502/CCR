...
MAKE_SYSTEM_PROP(ACTIVITY,UICCRNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UICCRNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UICCRNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UICCRNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UICCRNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UICCRNativeItemContactAdd);
