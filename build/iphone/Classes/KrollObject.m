 ...
 * Copyright (c) 2009-2012 by CCR, Inc. All Rights Reserved.
...
//@interface CCRObject : NSObject
//@end

@interface CCRObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CCRObject class]])
		{
			for (NSString *key in [[(CCRObject*)o modules] allKeys])
			{
