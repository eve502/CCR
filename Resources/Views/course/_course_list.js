...
-// 
-var _setting_data = [
-	{title:L('account'), hasChild:true, url:'/Views/Account/_signIn.js', leftImage:'/images/icon/ico_setting_account.png'},
-	{title:L('feedback'), hasChild:true, url:'/Views/Account/_signUp.js', leftImage:'/images/icon/ico_setting_feedback.png', header:''},
