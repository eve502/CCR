...
if(currentUserType == 0){	
	...
	//教师
	var subject_data = [
		{title:"一年级1班", hasChild:true, url:'/Views/course/course_list.js', leftImage:'/images/icon/ico_setting_account.png'},
		{title:"一年级2班", hasChild:true, url:'/Views/course/course_list.js', leftImage:'/images/icon/ico_setting_feedback.png'},
		{title:"二年级2班", hasChild:true, url:'/Views/course/course_list.js', leftImage:'/images/icon/ico_setting_feedback.png'},
	];
}
